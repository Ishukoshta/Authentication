...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-linear-to-br from-blue-200 to bg-purple-400'>
      ...
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <p className='text-center text-sm mb-6'>{state === 'Sign Up' ? 'Create an account' : 'Login account'}</p>
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <button className='w-full py-2.5 font-medium text-white rounded-full cursor-pointer bg-linear-to-r from-indigo-500 to-indigo-900'>{state}</button>
